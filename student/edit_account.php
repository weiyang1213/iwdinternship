					...
					<div class="row">					
						<div class="col-md-6">
				            ...
				            <!-- <div class="md-form form-sm"> <i class="fa fa-envelope prefix"></i>
				              <input type="email" id="email" class="form-control form-control-sm" name="email" value="<?php echo $cus_email;?>" readonly>
...
<?php
	...
	//	$ip = getIp();
		...
		$updateCus = "UPDATE customers SET fullname = '$fullname', /*email = '$email',*/ address1 = '$address1', address2 = '$address2', city = '$city', state = '$state', zipcode = '$zipcode', phone = '$phone', country = '$country' WHERE id = '$cus_id'";
