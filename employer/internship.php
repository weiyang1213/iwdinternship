<?php 
  ...
  include('includes/headerforemp.php');
?>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="text-center" style="color: #757575;" action="internship.php?<?=((isset($_GET['edit']))?'edit='.$edit_id:'add=1');?>" method="post" enctype="multipart/form-data">
              ...
              <!-- About Internship -->
              <div class="md-form">
                <textarea id="aboutInternship" name="aboutInternship" class="md-textarea form-control" rows="3" required></textarea>
              ...
              <div class="md-form">
                ...
                <label for="duration">Duration (Monthly)</label>
              </div>
              <!-- Stipend -->
              <div class="md-form">
              ...
              <!--Material textarea-->
              <div class="md-form">
                <textarea id="whoCanApply" name="whoCanApply" class="md-textarea form-control" value="<?=$whoCanApply;?>" rows="3" required><?=$whoCanApply;?></textarea>
                <label for="whoCanApply">Who Can Apply</label>
              </div>

              <div class="card-footer">
                <button class="btn btn-black waves-effect z-depth-0" type="submit" name="add" href="./internship.php"><?=((isset($_GET['edit']))?'EDIT':'ADD');?> INTERNSHIPS</button>
              </div>
            </form>
          </div>      
        </div>
      ...
      <div class="container-fluid table-responsive">  
        ...
        <table class="table table-striped table-bordered" style="display: table;">
          <thead>
            <th></th>
            <th></th>
            <th class="text-center"><h5 class="h5-responsive"><b>Job category</b></h5></th>
