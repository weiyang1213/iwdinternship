			...
			<div class="container-fluid">
				<form class="p-3 grey-text" method="post" action="" enctype="multipart/form-data">
		            ...
		            <div class="text-center mt-4">
		              	<button class="btn btn-primary" type="submit" name="update_password">Change Password <i class="fa fa-paper-plane-o ml-1"></i></button>
			        </div>					
				</form>
			</div>
		</div>
...
<?php
	...
	if(isset($_POST['update_password'])){
		...
		if($confirm_password != $new_password){
			...
			$updatePassword = "UPDATE employer SET password = '$new_password' WHERE email = '$email'";
