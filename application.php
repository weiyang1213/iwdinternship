...
<body>
	...
	<img src="./img/employeeimage/employeehero.png" alt="index hero image" class="mx-auto d-block mt-3 mt-2" style="width: 400px;">
	<h2 class="text-center p-3">Dear <?=$cus_name;?>, You have successfully applied for <b><?=$int_name; ?></b> internship by <b><i><?=$company_name;?></i></b></h2>
	<h2 class="text-center p-3"><i>Remember to check your email! Hope good new from you ! </i></h2>
